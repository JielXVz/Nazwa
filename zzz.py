...
if __name__ == '__main__':
      with suppress(KeyboardInterrupt):
          with suppress(IndexError):
              ...
              logger.info(
                  f"{bcolors.OKCYAN}Attack Started to{bcolors.OKBLUE} %s{bcolors.OKCYAN} with{bcolors.OKBLUE} %s{bcolors.OKCYAN} method for{bcolors.OKBLUE} %s{bcolors.OKCYAN} seconds, threads:{bcolors.OKBLUE} %d{bcolors.OKCYAN}!{bcolors.RESET}"
                  % (target or url.host, method, timer, threads))
              event.set()
              ts = time()
              while time() < ts + timer:
                  logger.debug(f'{bcolors.OKCYAN}Target:{bcolors.OKBLUE} %s,{bcolors.OKCYAN} Port:{bcolors.OKBLUE} %s,{bcolors.OKCYAN} Method:{bcolors.OKBLUE} %s{bcolors.OKCYAN} PPS:{bcolors.OKBLUE} %s,{bcolors.OKCYAN} BPS:{bcolors.OKBLUE} %s / %d%%{bcolors.RESET}' %
                               (target or url.host,
